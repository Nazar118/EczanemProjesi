...
import VitrinProducts from './pages/Vitrin/VitrinProducts';
      ...
      <div className="d-flex">
        ...
        <div className="flex-grow-1 p-4 bg-light" style={{ minHeight: "100vh" }}>
          <Routes>
           ...
           <Route path="/vitrin/products" element={user ? <VitrinProducts /> : <Navigate to="/login" />} />
           <Route path="/vitrin-kategorileri" element={user ? <ShowcaseCategories /> : <Navigate to="/login" />} />
